...
| `docs/schema-builder-ui.html` | Authoring an agent: the system prompt and flat input/output schema builder, how the platform assembles the model request from them and SOAR's input (with a full phishing example), validation, and the contract constraints behind it | Draft |
